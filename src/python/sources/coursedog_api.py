...
#             (f"{self.school.general_key}Shells.json", general_shells),
#             (f"{self.school.honors_key}Shells.json", honors_shells),
#             (f"{self._ALL_COURSE_KEY}.json", all_courses),
#             (f"{self.school.general_key}.json", general_courses),
#             (f"{self.school.honors_key}.json", honors_courses)
#         ]
